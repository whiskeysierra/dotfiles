...
alias eg='cd/~/Projects/engineering-guidelines'
...
alias pos='cd ~/Projects/place-order-service'
alias qs='cd ~/Projects/quote-service'
alias rop='cd ~/Projects/rules-of-play'
alias ros='cd ~/Projects/return-order-service'
alias rr='cd ~/Projects/returnability-relay'
alias rs='cd ~/Projects/returnability-service'
