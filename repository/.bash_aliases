...
alias it='mvn clean verify -Pintegration-test -DskipFullDatabase=true -Dlogging.context.forceEnabled=false'
alias itdb='mvn clean verify -Pintegration-test -Dlogging.context.forceEnabled=false'
